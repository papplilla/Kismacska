; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26726.0 
	...
	TITLE	d:\VS_Projects\Hetero_HW_2\_src\main.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0CJ@CGIOHNFJ@d?3?2vs_projects?2hetero_hw_2?2_src@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0CJ@CGIOHNFJ@d?3?2vs_projects?2hetero_hw_2?2_src@
CONST	SEGMENT
??_C@_0CJ@CGIOHNFJ@d?3?2vs_projects?2hetero_hw_2?2_src@ DB 'd:\vs_project'
	DB	's\hetero_hw_2\_src\main.cpp', 00H		; `string'
CONST	ENDS
...
; File d:\vs_projects\hetero_hw_2\_src\main.cpp
;	COMDAT _main
_TEXT	SEGMENT
...
; 21   : {
	...
	rep stosd
	mov	ecx, OFFSET __415E377E_main.cpp
...
; 41   : 	imgSrcExt = (unsigned char *)(_aligned_malloc(3*imgWidthF*imgHeightF*sizeof(unsigned char), 32));
	...
	push	eax
	push	OFFSET ??_C@_0CJ@CGIOHNFJ@d?3?2vs_projects?2hetero_hw_2?2_src@
	push	32					; 00000020H
