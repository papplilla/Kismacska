...
#ifndef __fir_hw_mac_muladdbkb__HH__
#define __fir_hw_mac_muladdbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fir_hw_mac_muladdbkb) {
    ...
    SC_CTOR(fir_hw_mac_muladdbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
